 ...
 *
 * $Id: fiche.php,v 1.2 2010/04/27 08:14:07 grandoc Exp $
 */
...
// seule action importer
      ...
      else
	{
	  print "\n<div class=\"tabsAction\">\n";
		  print "<p>ERROR 1c</p>\n";
		  dol_print_error('',"erreur webservice ".$osc_order->error);
		  print '<a class="butAction" href="index.php">'.$langs->trans("Retour").'</a>';
	  print "\n</div><br>\n";
	}
 }
...
/* utilisation de la table de transco*/
		...
		{
			print '<p>Cette commande existe d�j�</p>';
		}
		else {
...
//				print "<p>traitement de ".$commande->lines[$lig]->fk_product."</p>";
		    ...
		    {
				  print "\n<div class=\"tabsAction\">\n";
		       	  print '<br>cr�ation r�ussie nouvelle commande '.$id;
...
llxFooter('$Date: 2010/04/27 08:14:07 $ - $Revision: 1.2 $');
?>
