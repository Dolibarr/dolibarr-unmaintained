 ...
 *
 * $Id: THELIAvente.php,v 1.4 2010/03/22 15:30:59 hregis Exp $
 */
...
//		print '<br/>';
		...
		elseif (!($err=$client->getError()) )
		{
			...
			// creation de l'enregistrement dans osc_products
				...
				print "<p>le produit ".$product->ref." ".$product->libelle.' est en vente en ligne <a href="'.THELIA_URL.'product_info.php?products_id='.$result.'">consulter</a></p>';
				print "\n";
//			print_r($result);
	...
	{
		print "<p>Le produit ".$_POST["idprod"].' est deja en vente en ligne : <a href="'.THELIA_URL.'product_info.php?products_id='.$oscid.'">consulter</a></p>';
		print "\n";
	}
}
