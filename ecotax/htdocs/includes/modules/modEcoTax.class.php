...
/**
 *		\file       htdocs/includes/modules/modEcoTax.class.php
 *		\ingroup    composition
 *		\brief      Description and activation file for module EcoTax
 *		\version	$Id: modEcoTax.class.php,v 1.1 2010/07/13 23:37:08 eldy Exp $
 */
...
/**     \class      modEcoTax
 *		\brief      Description and activation class for module EcoTax
 */
class modEcoTax extends DolibarrModules
{
	...
	function modEcoTax($DB)
	{
		...
		$this->description = "Module to build ecotax lines automatically";
