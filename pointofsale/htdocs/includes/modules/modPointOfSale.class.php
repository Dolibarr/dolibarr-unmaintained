...
/**
 * 		\defgroup   pointofsale     Module PointOfSale
 *      \brief      Module descriptor for module PointOfSale
 */

/**
 *      \file       htdocs/includes/modules/modPointOfSale.class.php
 *      \ingroup    pointofsale
 *      \brief      Description and activation file for module PointOfSakle
 *		\version	$Id: modPointOfSale.class.php,v 1.1 2010/10/29 16:40:50 hregis Exp $
 */
include_once(DOL_DOCUMENT_ROOT ."/includes/modules/DolibarrModules.class.php");


/**
 * 		\class      modPointOfSale
 *      \brief      Description and activation class for module MyModule
 */
class modPointOfSale extends DolibarrModules
{
	/**
	 *   \brief      Constructor. Define names, constants, directories, boxes, permissions
	 *   \param      DB      Database handler
	 */
	function modPointOfSale($DB)
	{
		$this->db = $DB;
		...
		$this->description = "Module to manage a point of sale";
		...
		$this->style_sheet = '' ;//'/pointofsale/pointofsale.css';

		// Config pages. Put here list of php page names stored in admmin directory used to setup module.
		$this->config_page_url = array("pointofsale.php@pointofsale");
		...
		$this->langfiles = array("pointofsale");
		...
		// Example:
		$this->rights[$r][0] = 50201; 				// Permission id (must not be already used)
		$this->rights[$r][1] = 'Use cashdesk';	// Permission label
		$this->rights[$r][3] = 1; 					// Permission by default for new user (0/1)
		$this->rights[$r][4] = 'cashdesk';				// In php code, permission will be checked by test if ($user->rights->permkey->level1->level2)
		$this->rights[$r][5] = 'use';				// In php code, permission will be checked by test if ($user->rights->permkey->level1->level2)
		$r++;
		
		$this->rights[$r][0] = 50202 ;
		$this->rights[$r][1] = 'See cashdesk stats' ;
		$this->rights[$r][3] = 1 ;
		...
		$this->menu[$r]=array(	'fk_menu'=>0,			// Put 0 if this is a top menu
								...
								'titre'=>'PointOfSale',
								'mainmenu'=>'pointofsale',
								'leftmenu'=>'1',		// Use 1 if you also want to add left menu entries using this descriptor.
								'url'=>'/pointofsale/index.php',
								'langs'=>'@pointofsale',	// Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
								'position'=>100,
	...
	{
		return $this->_load_tables('/pointofsale/sql/');
	}
}
