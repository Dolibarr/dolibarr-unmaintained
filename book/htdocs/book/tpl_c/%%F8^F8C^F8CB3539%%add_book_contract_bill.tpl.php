<?php /* Smarty version 2.6.26, created on 2010-03-30 11:54:26
         compiled from /var/www/eclipse/dolibarr29_mod/htdocs/boo./tpl/add_book_contract_bill.tpl */ ?>
...
<table class="border" width="100%">
	<tr>
		<td width="25%"><?php echo $this->_tpl_vars['data']['book_contract_bill_date_deb']['label']; ?>
</td>
		<td><?php echo $this->_tpl_vars['data']['book_contract_bill_date_deb']['html_input']; ?>
</td>
	</tr>
	<tr>
		<td><?php echo $this->_tpl_vars['data']['book_contract_bill_date_fin']['label']; ?>
</td>
		<td><?php echo $this->_tpl_vars['data']['book_contract_bill_date_fin']['html_input']; ?>
</td>
	</tr>
