 ...
 *
 * $Id: graph-statistiques-lignes.php,v 1.1 2009/10/20 16:19:22 eldy Exp $
 * $Source: /cvsroot/dolibarr/dolibarrmod/telephonie/htdocs/telephonie/script/graph-statistiques-lignes.php,v $
 *
 *
...
for ($i = 1; $i < sizeof($GLOBALS["argv"]); $i++)
{
  switch($GLOBALS["argv"][$i])
    ...
    case "-v":
      ...
      break;
    case "--version":
      echo  $GLOBALS['argv'][0]." $Revision: 1.1 $\n";
      exit;
      break;
    case "--all":
      $graph_all = 1;
