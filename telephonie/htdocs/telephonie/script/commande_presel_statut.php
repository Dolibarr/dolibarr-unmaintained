 ...
 *
 * $Id: commande_presel_statut.php,v 1.1 2009/10/20 16:19:22 eldy Exp $
 * $Source: /cvsroot/dolibarr/dolibarrmod/telephonie/htdocs/telephonie/script/commande_presel_statut.php,v $
 *
 *
...
if (sizeof($ids) == 0)
{
  _log($GLOBALS["argv"][0]. " Aucune lignes � traiter - fin", LOG_NOTICE);
  exit(0);
}
  ...
  foreach($ids as $cli)
      ...
      else
	{
	  ...
	  if ($ligne_numero)// && $ligne_service && $ligne_presel)
	    ...
	    {
	      _log("$cli ERREUR impossible de r�cup�rer les infos", LOG_ERR);
	    }
