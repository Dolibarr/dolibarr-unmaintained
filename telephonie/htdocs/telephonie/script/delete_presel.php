 ...
 *
 * $Id: delete_presel.php,v 1.1 2009/10/20 16:19:24 eldy Exp $
 * $Source: /cvsroot/dolibarr/dolibarrmod/telephonie/htdocs/telephonie/script/delete_presel.php,v $
 *
 *
  ...
  while ($i < $num)
    {
      ...
      $result = DeletePreselection($host, $user_login, $user_passwd, $obj->ligne, $num_abo);
