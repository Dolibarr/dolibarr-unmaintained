...
$message ="Bonjour,\n\n";
$message .= "Veuillez trouver ci-joint la liste des lignes r�sili�es ces 7 derniers jours avec le chiffre d'affaire moyen.\n\n";
...
$message .="\n--\n";
$message .= "Ceci est un message automatique envoy� par dolibarr auquel vous ne pouvez pas r�pondre\n";
