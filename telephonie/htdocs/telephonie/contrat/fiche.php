      ...
      else
	{
	  ...
	  if ($result)
	      ...
	      if ($num > 0)
		{
		  ...
		  print '<tr class="liste_titre"><td>R�f</td>';	     
	...
	{ 
	  ...
	  if ($_GET["action"] <> 'edit' && $_GET["action"] <> 're-edit')
              ...
              if($conf->global->TELEPHONIE_CONTRAT_PLUGIN)
		{
	      ...
	      print '<tr><td width="20%">R�f�rence</td><td>'.$contrat->ref.'</td>';
	      print '<td>Factur� : '.$contrat->facturable.'</td><td align="right">';
	  ...
	  if ($_GET["action"] == 'edit' || $action == 're-edit')
	    {
	      ...
	      print '<tr><td width="20%">R�f�rence</td><td>'.$contrat->ref.'</td>';
	      print '<td>Factur� : '.$contrat->facturable.'</td></tr>';
	      ...
	      if ( $db->query( $sql) )
		{
	      ...
	      print '<tr><td width="20%">Client � facturer</td><td colspan="2">'."\n";
	      ...
	      if ( $db->query( $sql) )
		{
	       ...
	       *
	       */
	      print '<tr><td width="20%">Mode de r�glement</td>';
	      print '<td colspan="2">';
	      ...
	      foreach ($obg->liste as $grille)
		{
	      ...
	      print '<tr><td align="center" colspan="3"><input type="submit" value="Mettre � jour">';
