  ...
  if ( $socc->fetch($_GET["client"]) == 1)
      ...
      else
	{
	  ...
	  if (sizeof($contrats) > 0)
	    {
	      print '<tr><td width="20%">Num�ro de la ligne t�l�phonique</td><td><input name="numero" size="12" value="'.$ligne->numero.'"></td></tr>';
...
if ( $user->rights->telephonie->adsl->gerer && $ligne->statut == 2)
{
  ...
  print '<tr><td>Adresse IP affect�e</td><td><input size="30" type="text" name="ip"></td></tr>';
