 ...
 *
 * $Id: clientsmoyenne.week.class.php,v 1.1 2009/10/20 16:19:30 eldy Exp $
 * $Source: /cvsroot/dolibarr/dolibarrmod/telephonie/htdocs/telephonie/stats/clients/clientsmoyenne.week.class.php,v $
 *
 */

require_once (DOL_DOCUMENT_ROOT."/telephonie/stats/graph/line.class.php");

class GraphClientsMoyenneWeek extends GraphLine {

  Function GraphClientsMoyenneWeek($DB, $file)
  {
    $this->db = $DB;
    $this->file = $file;

    $this->client = 0;
    $this->titre = "Nouveaux clients par semaine (moyenne)";
