 ...
 *
 * $Id: clients.week.class.php,v 1.1 2009/10/20 16:19:29 eldy Exp $
 * $Source: /cvsroot/dolibarr/dolibarrmod/telephonie/htdocs/telephonie/stats/clients/clients.week.class.php,v $
 *
 */
...
class GraphClientsWeek extends GraphBarMoy {
  ...
  Function GraphClientsWeek($DB, $file)
  {
    ...
    $this->client = 0;
    $this->titre = "Nouveaux clients par semaine";
