 ...
 *
 * $Id: distributeur.ca.class.php,v 1.1 2009/10/20 16:19:25 eldy Exp $
 * $Source: /cvsroot/dolibarr/dolibarrmod/telephonie/htdocs/telephonie/stats/distributeurs/distributeur.ca.class.php,v $
 *
 */

require_once (DOL_DOCUMENT_ROOT."/telephonie/stats/graph/bar.class.php");

class GraphDistributeurCa extends GraphBar {

  Function GraphDistributeurCa($DB, $file)
  {
    $this->db = $DB;
    $this->file = $file;
    $this->client = 0;
  ...
  Function GraphMakeGraph($distributeur=0)
  {
    ...
    if ($distributeur > 0)
      {
	$sql .= " WHERE graph='distributeur.ca.mensuel.".$distributeur."';";
      }
    else
      {
    ...
    if ($distributeur > 0) {
      ...
      $sql .= " WHERE graph like 'distributeur.ca.mensuel.%'";
	...
	while ($i < $num)
	  {
	    ...
	    if ($distributeur > 0) {
	      $sqli .= " VALUES ('distributeur.ca.mensuel.".$distributeur."'";
	    }
	    else {
	      $sqli .= " VALUES ('distributeur.ca.mensuel'";
	    }
