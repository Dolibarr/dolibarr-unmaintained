 ...
 *
 * $Id: destmonth.php,v 1.1 2009/10/20 16:19:26 eldy Exp $
 * $Source: /cvsroot/dolibarr/dolibarrmod/telephonie/htdocs/telephonie/stats/communications/destmonth.php,v $
 *
 */
require("./pre.inc.php");
...
for ($i = 1 ; $i < 4 ; $i++)
{
  ...
  print '<img src="./dest_repart-'.$year.substr("00".$month, -2).'.png"><br /><br />';
...
for ($i = 1 ; $i < 4 ; $i++)
{
  ...
  print '<img src="./dest_temps_repart-'.$year.substr("00".$month, -2).'.png"><br /><br />';
