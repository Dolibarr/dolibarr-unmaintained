 ...
 *
 * $Id: rejet.week.class.php,v 1.1 2009/10/20 16:19:27 eldy Exp $
 * $Source: /cvsroot/dolibarr/dolibarrmod/telephonie/htdocs/telephonie/stats/lignes/rejet.week.class.php,v $
 *
 */
...
class GraphLignesRejetWeek extends GraphBar {

  Function GraphLignesRejetWeek($DB, $file)
  {
    $this->db = $DB;
    $this->file = $file;

    $this->client = 0;
    $this->titre = "Lignes rejetées par semaine";
