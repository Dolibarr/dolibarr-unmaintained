...
--
-- $Id: llx_telephonie_tarif_fournisseur.key.sql,v 1.1 2009/10/20 16:19:21 eldy Exp $
-- $Source: /cvsroot/dolibarr/dolibarrmod/telephonie/htdocs/telephonie/sql/llx_telephonie_tarif_fournisseur.key.sql,v $
--
-- ========================================================================
--
